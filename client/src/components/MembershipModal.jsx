    ...
    >
      <div className="bg-white p-8 rounded-3xl shadow-lg relative max-w-md w-full mx-4 max-h-screen overflow-y-auto">
        ...
        <h2
          ...
          className="text-center text-2xl font-semibold text-[#0B0757] mb-4"
        >
          What You Get with Your Membership
        </h2>

        <p className="text-center text-gray-600 mb-8">
          Join Elite Healthspan to unlock exclusive access to our network and
          resources, designed to enhance your wellness journey.
        </p>
        ...
        <div className="flex flex-col gap-4 mb-8">
          <div className="flex items-start gap-2">
            ...
            <p className="text-gray-700">
              Connections: Connect with top Providers, Scientists,
              Practitioners, and Advisors in Alternative Medicine.
            </p>
          </div>
          <div className="flex items-start gap-2">
            <span className="text-[#0B0757] mt-1">✔</span>
            <p className="text-gray-700">
              Learning: Access state-of-the-art knowledge and insights from
              industry leaders.
            </p>
          </div>
          <div className="flex items-start gap-2">
            <span className="text-[#0B0757] mt-1">✔</span>
            <p className="text-gray-700">
              Exploration: Discover innovative therapies, treatments and
              products that go beyond conventional approaches.
            </p>
          </div>
        </div>
        ...
        <div className="text-center text-gray-700 mb-6">
          ...
          <p>
            Enjoy a full year of access to Elite Healthspan&apos;s premium
