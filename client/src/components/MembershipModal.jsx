...
const MembershipModal = ({ onClose, onContinue }) => {
  return (
    <div style={{ fontFamily: 'Karla' }} className="fixed inset-0 backdrop-blur-md bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white p-8 rounded-3xl shadow-lg relative max-w-md w-full mx-4 max-h-screen overflow-y-auto">
        ...
        <h2 style={{ fontFamily: 'Montserrat' }} className="text-center text-2xl font-semibold text-[#0B0757] mb-4">
