...
const FAQSection = () => {
  ...
  return (
    ...
    >
      <h1 className="text-2xl md:text-[40px] font-bold text-center text-[#061140] mb-16">
        How It Works
      </h1>
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 px-4">
        {faqs.map((faq, index) => (
          ...
          >
            <h3 className="text-[16px] md:text-2xl font-semibold text-[#061140] mb-4">
              {faq.question}
            </h3>
            <p className="text-[#484848] font-normal mb-6 text-sm md:text-lg">
              {faq.answer}
            </p>
      ...
      >
        <button className="px-[108px] md:px-[135px] py-4 bg-[#0C1F6D] text-[#FFFFFF] rounded-full text-[16px] text-sm font-bold">
          View All Questions
        </button>
      </motion.div>
    </motion.div>
