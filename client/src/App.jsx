    ...
    <div className="flex flex-col min-h-screen">
      ...
      >
        <Routes>
          ...
          <Route path="/admin/orders" element={<AdminPlaceholder title="Orders Management" />} />
          <Route path="/admin/analytics" element={<AdminPlaceholder title="Analytics Dashboard" />} />
          <Route path="/admin/settings" element={<AdminPlaceholder title="Admin Settings" />} />
          <Route path="/admin/support" element={<AdminPlaceholder title="Support Center" />} />
